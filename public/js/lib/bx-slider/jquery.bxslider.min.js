...
!function (t) {
	...
	t.fn.bxSlider = function (n) {
		...
		var a = t(window).width(), l = t(window).height(), d = function () {
			...
			o.controls.next = t('<button class="bx-next" href="">' + '<i class="fa fa-angle-right fa-5x"></i>' + "</button>"), o.controls.prev = t('<button class="bx-prev" href="">' + '<i class="fa fa-angle-left fa-5x"></i>' + "</button>"), o.controls.next.bind("click", y), o.controls.prev.bind("click", z), o.settings.nextSelector && t(o.settings.nextSelector).append(o.controls.next), o.settings.prevSelector && t(o.settings.prevSelector).append(o.controls.prev), o.settings.nextSelector || o.settings.prevSelector || (o.controls.directionEl = t('<div class="bx-controls-direction" />'), o.controls.directionEl.append(o.controls.prev).append(o.controls.next), o.controls.el.addClass("bx-has-controls-direction").append(o.controls.directionEl))
		}, E = function () {
