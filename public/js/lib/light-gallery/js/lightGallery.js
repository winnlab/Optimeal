...
/*                this.buildThumbnail();*/
            ...
            loadVideo: function(src, _id) {
                ...
                if (youtube) {
                    ...
                    video = '<iframe class="object" width="1024" height="576" src="//www.youtube.com/embed/' + youtube[1] + a + '" frameborder="0" allowfullscreen></iframe>';
                } else if (vimeo) {
                    if (settings.videoAutoplay === true && lightGalleryOn === false) {
                        a = 'autoplay=1&amp;';
                    } else {
                    ...
                    video = '<iframe class="object" id="video' + _id + '" width="1024" height="576"  src="http://player.vimeo.com/video/' + vimeo[1] + '?' + a + 'byline=0&amp;portrait=0&amp;color=' + settings.vimeoColor + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                } else {
                    video = '<iframe class="object" frameborder="0" src="' + src + '"  allowfullscreen="true"></iframe>'
                }
                return '<div class="video_cont" style="width:' + settings.videoMaxWidth + 'px !important;"><div class="video">' + video + '</div></div>';
            },
            addHtml: function(index) {
                if (settings.html === true) {
                    ...
                    if (typeof dataHtml !== 'undefined' && dataHtml !== null) {
	                    ...
	                    var objectWidth = $slide.eq(index).find('.object').width();
                        if (fL == '.' || fL == '#') {
                            html = '<div class="htmlContent" style="width: '+objectWidth+'px;">' + $(dataHtml).html() + '</div>';
                        } else {
                            html = '<div class="htmlContent" style="width: '+objectWidth+'px;">'+dataHtml+'</div>';
                        }
	        ...
	        stopVideo: function () {
		        var $iframe = $('.lightGallery-slide.current').find('iframe');
